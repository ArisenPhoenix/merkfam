...
import navCss from "./NavItem/NavItem.module.css"
...
export const determineAcess = (isUser, isAdmin, requiresUser, requiresAdmin, isPublic ) => {
    const nonUserPrivelige = isPublic && !isUser
    const userPrivelige = !nonUserPrivelige && isUser && requiresUser
    const adminPrivelige = requiresAdmin && isAdmin && isUser
    const hasAccess = userPrivelige || nonUserPrivelige || adminPrivelige
